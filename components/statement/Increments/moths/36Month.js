...
const Month36 = ({id, selects, callback}) => {
  ...
  const creditChange = (id, val) => {
    ...
    selects[id].thirdQuantity = val;
    callback(selects.thirdQuantity, val);
  };
  ...
  const setFieldState = (index, value) => {
    ...
    selects[index].thirdMonth = value;
    callback(selects.thirdMonth, value);
  };
  return (
