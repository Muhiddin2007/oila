...
const Month60 = ({id, selects, callback}) => {
  ...
  const creditChange = (id, val) => {
    ...
    selects[id].fifthQuantity = val;
    callback(selects.fifthQuantity, val);
  };
  ...
  const setFieldState = (index, value) => {
    ...
    selects[index].fifthMonth = value;
    callback(selects.fifthMonth, value);
  };
  return (
