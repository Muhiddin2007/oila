...
const Month24 = ({id, selects, callback}) => {
  ...
  const creditChange = (id, val) => {
    ...
    selects[id].secondQuantity = val;
    callback(selects.secondQuantity, val);
  };
  ...
  const setFieldState = (index, value) => {
    ...
    selects[index].secondMonth = value;
    callback(selects.secondMonth, value);
  };
  return (
