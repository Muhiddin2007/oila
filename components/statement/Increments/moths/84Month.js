...
const Month84 = ({id, selects, callback}) => {
  ...
  const creditChange = val => {
    ...
    selects[id].seventhQuantity = val;
    callback(selects.seventhQuantity, val);
  };
  ...
  const setFieldState = (index, value) => {
    ...
    selects[index].seventhMonth = value;
    callback(selects.seventhMonth, value);
  };
  return (
