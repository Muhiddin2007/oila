    ...
    <View>
      <ScrollView>
        ...
        <View style={{alignItems: 'center'}}>
          ...
          <Text style={styles.title}>{route.params.title8}</Text>
          <Text style={styles.title}>{route.params.title9}</Text>
          <Text style={styles.title}>{route.params.title10}</Text>
          <Text style={styles.title}>{route.params.title11}</Text>
        </View>
      </ScrollView>
    </View>
  );
